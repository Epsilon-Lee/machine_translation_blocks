...
def get_config_de2en():
    ...
    config['saveto'] = os.path.dirname(os.path.relpath(__file__))
    ...
    config['src_data'] = datadir + 'bitext.de.tok'
    config['trg_data'] = datadir + 'bitext.en.tok'

    config['test_source'] = datadir + 'test.de.tok'
    config['test_target'] = datadir + 'test.en.tok'
